...
import control.cLifeInsurance;
import model.insurance.insurance.insuranceType;

public class lifeInsurancePanel implements ActionListener {
	// controller
	private cLifeInsurance cLifeInsurance = new cLifeInsurance();
	...
	public lifeInsurancePanel() {
		...
		this.idField.setText(cLifeInsurance.getID());
		...
		this.cCIDField.setText(cLifeInsurance.getID());
		...
		this.expirationDateField.setText("2060-06-20");
		...
		this.guaranteeAmountField.setText("200000000");
		...
		this.paymentAmountField.setText("10000");
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (actionEvent.getActionCommand().equals("저장")) {
			cLifeInsurance.makeInsurance(insuranceID, insuranceName, insuranceType.LIFEINSURANCE, description, contractConditionID,
					date, guaranteeAmount, paymentAmount, paymentDay);
